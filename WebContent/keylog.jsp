        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="healthcare.jsp" class="nav-link"><span data-hover="Health Care" style="color: blueviolet;"">Healthcare</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="keylog.jsp" class="nav-link"><span data-hover="Key Generator" style="color: blueviolet;">Key Generator</span></a>
                    </li>
                    <!-- <li class="nav-item">
